...
layer = [128, 128, 128]
# saddle_point = [0.06601893, 0.18404094]

w0 = np.array([0.15, 1.4])
steps = 400
k = 1
dt = 3e-4
...
model_path = os.path.join(current_dir, 'parameters/mmb.pth')
...
saddle0, record0 = core.hisdnn(model=net, w0=w0, v0=None, dt=dt, ds=dt,
                         nesterov=True, max_iter=steps, k=k, sub_iter=1, restart=15,
                         momentum=0.0, step_interval=100)
saddle1, record1 = core.hisdnn(model=net, w0=w0, v0=None, dt=dt, ds=dt,
                         nesterov=True, max_iter=steps, k=k, sub_iter=1, method='lobpcg', restart=15,
                         momentum=0.0, step_interval=100)
saddle2, record2 = core.hisdnn(model=net, w0=w0, v0=None, dt=dt, ds=dt,
                         max_iter=steps, k=k, sub_iter=1,
                         momentum=0.7, step_interval=100)
...
plt.semilogy(dist2, label='$\mathrm{NN{-}HiSD}_\mathrm{Hb}$, $\gamma$=0.7', color='blue')
